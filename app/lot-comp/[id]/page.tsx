      ...
      <div style={s.shell}>
        <div style={s.content}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 12, marginBottom: 16 }}>
            <div style={s.section}>
              <div style={{ fontSize: 11, color: "#555", marginBottom: 4, textTransform: "uppercase", letterSpacing: ".4px" }}>Card comp total</div>
            ...
            <div style={s.section}>
              ...
              <div style={{ fontSize: 22, fontWeight: 700, color: "#fb923c" }}>{selectedLot.giveaway_count} @ ${parseFloat(selectedLot.giveaway_comp || "0").toFixed(2)}</div>
            </div>
            <div style={s.section}>
          ...
          <div style={s.section}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
              ...
              <a href={sellerLink} target="_blank" style={{ ...s.submitBtn, whiteSpace: "nowrap", padding: "10px 20px", textDecoration: "none", background: "#1a1a2e", border: "1px solid #333" }}>
                Open ↗
              </a>
            </div>
          </div>
          ...
          <div style={s.section}>
            ...
            {status === "pending" && (
              <p style={{ fontSize: 12, color: "#555", marginBottom: 12 }}>Tracking will be available once the seller accepts the offer.</p>
            )}
      ...
      <div style={s.content}>
        ...
        <div style={s.section}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 12 }}>
            ...
            <div><label style={s.label}>Fixed price per giveaway card ($)</label><input style={s.input} type="number" min={0} step="0.01" placeholder="e.g. 1.50" value={giveawayPricePerCard} onChange={e => setGiveawayPricePerCard(e.target.value)} /></div>
            ...
            <table style={{ width: "100%", borderCollapse: "collapse", fontSize: 13 }}>
              <thead>
                <tr style={{ background: "#0f0f0f" }}>
                  ...
                  <th style={s.th}>Card comp</th>
                  <th style={s.th}>Total offer</th>
